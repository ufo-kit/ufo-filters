...
static void
ufo_center_of_rotation_task_get_structure (UfoTask *task,
                                           guint *n_inputs,
...
static gboolean
ufo_center_of_rotation_task_process (UfoCpuTask *task,
                                     UfoBuffer **inputs,
                                     UfoBuffer *output,
                                     UfoRequisition *requisition)
{
...
ufo_task_interface_init (UfoTaskIface *iface)
{
    ...
    iface->get_structure = ufo_center_of_rotation_task_get_structure;
