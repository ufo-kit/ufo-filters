...
static void
ufo_forwardproject_task_get_structure (UfoTask *task,
                                       guint *n_inputs,
...
static gboolean
ufo_forwardproject_task_process (UfoGpuTask *task,
                                 UfoBuffer **inputs,
                                 UfoBuffer *output,
                                 UfoRequisition *requisition)
{
...
ufo_task_interface_init (UfoTaskIface *iface)
{
    ...
    iface->get_structure = ufo_forwardproject_task_get_structure;
