...
ufo-launch -q read path=ones-ifft-mean-check.tif ! fft dimensions=2 auto-zeropadding=True ! ifft dimensions=2 crop-width=9 crop-height=9 ! write filename=ones-ifft-mean-check-back.tif
